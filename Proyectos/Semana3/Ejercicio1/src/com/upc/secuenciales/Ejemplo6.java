...
public class Ejemplo6 {
    ...
    static double obtenerPrecio(int examenEscrito, int examenOral){
        String nivel = obtenerNivel(examenEscrito, examenOral);//llamando al método para reutilizarlo
        double precio=0;
        if(nivel == "Nivel 1"){
            precio = 150;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Precio del Curso:" + obtenerPrecio(examenEscrito, examenOral));
    }
